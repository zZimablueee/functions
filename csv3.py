...
def process_csv(csv_file, engine, depth, is_verbose):
    ...
    with open(csv_file, 'r', newline='', encoding='utf-8') as file:
        ...
        for row in csv_reader:
            ...
            all_games.append((white_player, black_player, avg_cp_white, final_acc_white, avg_cp_black, final_acc_black))
...
#  python csv3.py 16 2 C:\Users\Administrator\Desktop\stockfish-windows-x86-64-avx2\stockfish\stockfish-windows-x86-64-avx2.exe -file=C:\Users\Administrator\Desktop\findcode\output\master_games.pgn_processed.csv -verbose
